            ...
            <div class="">
                ...
                <div class="col col-login mx-auto mt-7">
                    <div class="text-center">
                        <img src="{{ asset('backend') }}/assets/images/brand/logo-white.png" class="header-brand-img m-0" alt="">
                    </div>
                </div>
                    ...
                    <div class="wrap-login100 p-6">
                        <form method="POST" action="{{ route('register') }}" >
                            ...
                            <div class="wrap-input100 validate-input input-group">
                                ...
                                <input class="input100 border-start-0 ms-0 form-control" name="first_name" type="text" placeholder="First Name">
                                <br>
                                @error('first_name') 
                            ...
                            <div class="wrap-input100 validate-input input-group">
                                ...
                                <input class="input100 border-start-0 ms-0 form-control" name="last_name" type="text" placeholder="Last Name">
                                @error('last_name') 
                                    <span class="invalid-feedback text-danger d-block">
                                        <strong>{{ $message }}</strong>
                                    </span> 
                            ...
                            <div class="wrap-input100 validate-input input-group">
                                ...
                                <input class="input100 border-start-0 ms-0 form-control" name="username" type="text" placeholder="Username">
                                @error('username') 
                                    <span class="invalid-feedback text-danger d-block">
                                        <strong>{{ $message }}</strong>
                                    </span> 
                            ...
                            <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                ...
                                <input class="input100 border-start-0 ms-0 form-control" name="password_confirmation" name="password_confirmation"  type="password" placeholder="Password">
                            ...
                            <div class="container-login100-form-btn">										
                                <button class="login100-form-btn btn-primary" style="border:none" type="submit">Register</button>
                            </div>
