        ...
        <tr>
            <td>
                <table style="width: 100%; max-width: 650px; height: 60px; margin: auto; background:#F8F7FC">
                    <tr>
                        <td style="width: 40px;"></td>
                        <td style="font-size: 16px; color: gray;"><button style="padding: 5px 10px; background-color: rgb(157, 176, 194); border:none; border-radius: 5px" ><a style="color: rgb(0, 0, 11);" href="{{route('returnBack')}}">Back</a></button> </td>
                        <td style="width: 40px;"></td>
                    </tr>
                </table>
            </td>
