                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="{{ route('home') }}">
                            ...
                            <img src="{{ asset('backend') }}/assets/uploads/brand/header-logo.webp" class="header-brand-img light-logo1"
                                alt="logo">
                        </a>
                        <!-- LOGO -->
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © <span id="year"></span> <a href="javascript:void(0)">NepGov</a>. Designed with <span
                            class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> NepGov </a> All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
