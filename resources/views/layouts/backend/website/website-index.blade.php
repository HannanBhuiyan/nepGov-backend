        ...
        <div class="card p-3 mt-4">
            ...
            <form action="{{ route('settings.update', $items->id ?? '') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="seo_title" id="input_title" maxlength="60" value="{{ $items->seo_title ?? '' }}">
                    <p class="text-danger" id="div_title"></p>
                </div>

                <div class="form-group">
                    <label class="form-label">SEO Description</label>
                    <textarea class="form-control" id="input_desc" rows="10" maxlength="160" name="seo_description"  placeholder="Description">{{ $items->seo_description ?? ''}}</textarea><p class="text-danger" id="div_desc"></p>
                </div>
                ...
                <div class="form-group">
                    <label class="form-label">Footer About <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                  <label class="form-label">Need Varification <span class="text-danger">*</span></label>
                  <select name="need_varification" class="form-control">
                    <option value="no" {{ $items->need_varification == 'no' ? 'selected' : ''}}>No</option>
                    <option value="yes" {{ $items->need_varification == 'yes' ? 'selected' : ''}}>Yes</option>
                </select>
              </div>
              @error('need_varification')
                  <span class="text-danger">{{ $message }}</span>
              @enderror
...
<script>
  ...
  // prevent enter press tfrom submit
