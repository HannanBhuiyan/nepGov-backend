            ...
            <td>
                <table style="width: 100%; max-width: 650px; margin: auto; background: #fff;">
                    <tr>
                        ...
                        <td style="text-align: center; font-size: 20px; font-weight: 700;">Congratulation, You are assigned to the Role:-</td>
                        <td style="width: 40px;"></td>
                    </tr>
                </table>
            </td>
    ...
    <table style="width: 100%;">
        <tr>
            <td>
                <table style="width: 100%; max-width: 650px; margin: auto; background: #fff;">
                    <tr>
                        <td style="text-align: center; font-size: 30px; font-weight: bold;">Role : {{ $role }}</td>
                    </tr>
                </table>
            </td>
        </tr>
